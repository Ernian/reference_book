        ...
        articles: [
            ...
            },
            {
                ...
                description: [
                    ...
                    {
                        code: 'git config --system',
                        description: 'общесистемные настройки'
                    },
                    {
                        code: 'git config --global',
                        description: 'настройки на уровне конкретного пользователя'
                    },
                    {
                        code: 'git config --local',
                        description: 'настройки на уровне конкретного проекта'
                    },
                    {
                        code: 'git config --global user.name "John Doe"',
                        description: 'установка имени пользователя'
                    },
                    {
                        code: 'git config --global user.email johndoe@example.com',
                        description: 'установка почты пользователя'
                    },
                ],
                source: [
                    { 
                        name: 'Первоначальная настройка Git',
                        path: 'https://git-scm.com/book/ru/v2/Введение-Первоначальная-настройка-Git'
                    },
                ],
            },
        ],
    },
    {
        ...
        articles: [
            ...
            },
            {
                ...
                description: [
                    {
                        code: 'git status -s || git status -short',
                        description: 'упрощенный вывод '
                    },
                ],
                source: [],
            },
            {
                ...
                description: ['Если результат работы команды git status недостаточно информативен и хочется знать, что конкретно поменялось, а не только какие файлы были изменены — можно использовать команду git diff. Ее основное применение - это получение ответов на два вопроса: что вы изменили, но еще не проиндексировали, и что вы проиндексировали и собираетесь добавить в коммит.',
                    ...
                    {
                        code: 'git diff --staged || git diff --cached',
                        description: 'Если вы хотите посмотреть, что вы проиндексировали и что войдет в следующий коммит, эта команда сравнивает ваши проиндексированные изменения с последним коммитом.'
                    },
                ],
                source: [],
            },
